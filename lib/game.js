...
function checkScoreIncrease() {
  ...
  && firstPipe.point === true)  {
    ...
    if (gameMode === 'easy') {
      if (gameScore > difficulty.easy.highScore) {
        let newHighScore = gameScore

        difficulty.easy.highScore = newHighScore;
      }
    } else {
      if (gameScore > difficulty.hard.highScore) {
        let newHighScore = gameScore

        difficulty.hard.highScore = newHighScore;
      }
    }
  }
}
