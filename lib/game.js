...
function detectColllision() {
  ...
  if (pipeArray.length > 0) {
    if (
        player.x < pipeArray[0].x + pipeArray[0].width &&
        player.x + player.width > pipeArray[0].x &&
        player.y < pipeArray[0].top.y + pipeArray[0].top.height  &&
        player.height + player.y > pipeArray[0].top.y

        ||

        player.x < pipeArray[0].x + pipeArray[0].width &&
        player.x + player.width > pipeArray[0].x &&
        player.y < pipeArray[0].bottom.y + pipeArray[0].bottom.height  &&
        player.height + player.y > pipeArray[0].bottom.y
