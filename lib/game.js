...
function checkScoreIncrease() {
  ...
  && firstPipe.point === true)  {
    ...
    if (gameMode === 'easy' && gameScore > difficulty.easy.highScore) {
      difficulty.easy.highScore = gameScore;
    } else if (gameMode === 'hard' && gameScore > difficulty.hard.highScore) {
      difficulty.hard.highScore = gameScore;
    }
  }
}
...
function displayScore() {
  ...
  gameMode === 'easy' ? c.fillText(difficulty.easy.highScore, 220, 60)
                      : c.fillText(difficulty.hard.highScore, 220, 60)
}
